...
const REQUIRED_ACTIONS: ReadonlyArray<{
  ...
  { dataTest: 'round-picker-minus', action: 'round-decrease', icon: 'mdi-minus-circle-outline' },
  { dataTest: 'round-picker-plus', action: 'round-increase', icon: 'mdi-plus-circle-outline' },
